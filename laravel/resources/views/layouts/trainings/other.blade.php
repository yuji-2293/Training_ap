...
<!--ChestCard  -->
 ...
 <div class="text-center">
                ...
                <li class="">
                    <x-form class="">
                    <input class="focus:border-rose-500 focus:ring-rose-500 hover:border-gray-500 rounded-md h-10 border-separate border border-slate-300 shadow" type="text" name="title" value="{{$item->name}}">
