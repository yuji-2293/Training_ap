<form action="{{ route('store') }}" method="POST" autocomplete="off">
    ...
    <div class="relative inline-block w-32">
        <select name="sets" id="sets" class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-500
         px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline-red focus:border-blue-600" autocomplete="off">
    ...
    <div class="relative inline-block w-32">
     <select name="weight" id="weight" class=" px-4 py-2 pr-8 block appearance-none w-full bg-white border border-gray-300 hover:border-gray-500
      rounded shadow leading-tight focus:outline-none focus:shadow-outline-red focus:border-blue-600" autocomplete="off">
    ...
    <button class="inline-block p-2 bg-rose-500 rounded-lg shadow  text-white max-w-xs md:hover:bg-sky-300  hover:bg-sky-300 transition-colors" type="submit">登録する</button>
</form>
