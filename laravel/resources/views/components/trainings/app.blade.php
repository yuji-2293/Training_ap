         ...
         <header class="bg-sky-600 flex justify-around">
                <div class="text-white text-lg font-bold max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <div class="py-4 w-full flex space-x-20 items-end items-center">
                        ...
                        <a href="{{ route('part_create') }}" class="font-semibold  hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 outline-none hover:outline-red-500 hover:rounded-sm">登録メニュー</a>
                        <a href="{{ route('trainings.create') }}" class="font-semibold  hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 outline-none hover:outline-red-500 hover:rounded-sm">ワークアウトの登録</a>
                        <a href="{{ route('trainings.Mymenu') }}" class="font-semibold  hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 outline-none hover:outline-red-500 hover:rounded-sm">マイメニューの登録</a>
                        ...
                        class="font-semibold  hover:text-gray-900 dark:text-gray-400 dark:hover:text-white flex items-center
                         focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 outline-none hover:outline-red-500 hover:rounded-sm" type="button">{{ Auth::user()->name }}
